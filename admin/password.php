...
<body>
	<header class="navbar fixed-top bg-warning flex-md-nowrap shadow-lg py-2">
		<p class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-3 text-dark fw-bold my-auto ms-5">Halaman Admin</p>
  		...
  		<div class="nav">
    		<span class="nav-item text-nowrap my-auto fs-5">Selamat Datang, <b><?php echo $username ?>!</b></span>
			...
			<div class="container w-50 pt-3">
				<form method="POST" action="">
					...
					<div class="mb-3">
						...
						<input type="password" name="passlama" class="form-control" id="passlama" placeholder="Masukkan Password Lama">
					</div>
					<div class="mb-3">
						<label for="passbaru" class="form-label">Password Baru</label>
						<input type="password" name="passbaru" class="form-control" id="passbaru" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,16}" placeholder="Masukkan Password Baru" required>
					...
					<div class="mb-3">
						...
						<input type="password" name="verpassbaru" class="form-control" id="verpassbaru" onKeyUp="validatePassword()" placeholder="Masukkan Kembali Password Baru" required>
						<div class="form-text"><i>** Verifikasi Password harus sesuai dengan Password Baru.</i></div>
					</div>
					<div class="mb-3">
						<button type="submit" name="submit" class="btn btn-primary" onClick="validatePassword()">Ubah</button>
					</div>
				</form>
			</div>
			</div>
