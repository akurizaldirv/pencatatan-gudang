...
$data = getData("SELECT * FROM KATEGORI ORDER BY ID_KATEGORI");
?>
<!DOCTYPE html>
<html>
<head>
	    ...
	    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse">
	      <div class="position-sticky pt-3 sidebar-sticky pt-5">
	        <ul class="nav flex-column mt-5">
	          ...
	          <li class="nav-item">
	            <a class="nav-link active text-dark fw-bold rounded-3 bg-warning" aria-current="page" href="kategori.php">
	              Daftar Kategori
	            </a>
	          </li>
	          <li class="nav-item">
			...
			<div class="table-responsive mx-5 mt-3">
				...
				<thead>
					<tr>
						...
						<th scope="col" class="table-dark">Nama Kategori</th>
				...
				<?php $i = 1; ?>
					...
					<tr>
						...
						<td>
							<a href="editKategori.php?id_kategori=<?= $row['ID_KATEGORI'] ?>" title="Sunting Data"><img alt="Sunting Data" src="../assets/img/edit3-icon.svg" width="25px" height="25px"></img></a>
							<a href="deleteKategori.php?id_kategori=<?= $row['ID_KATEGORI'] ?>" onClick="return confirm('Hapus Data Kategori ini?')" title="Hapus Data"><img alt="Hapus Data" src="../assets/img/delete2-icon.svg" width="25px" height="25px" class="ms-2"></img></a>
						</td>
					</tr>
					<?php $i++ ?>
					<?php endforeach ?>
